...
setup(
    ...
    packages=find_packages(include=["Djreact", "Djreact.*", "Djreact.templates", "Djreact.templates.*", "Djreact.templates.ReactTS.*", "Djreact.templates.ReactJS.*", "Djreact.templates.Django.*", "Djreact.templates.ReactDJ.*"], exclude=["tests"]),
